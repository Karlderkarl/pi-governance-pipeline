...
export function git(root, args, { input = null, env = process.env } = {}) {
	const r = spawnSync("git", ["-C", root, ...args], { encoding: null, input, env, maxBuffer: 64 * 1024 * 1024, windowsHide: true });
